        ...
        <div className="mt-4 space-y-4">
          {comments.length > 0 ? (
                ...
                <CardContent className="p-4">
                  <div className="flex flex-col">
                      ...
                      {comment.attributes.html ? (
                        <div
                          dangerouslySetInnerHTML={{
                            __html: comment.attributes.html,
                          }}
                        />
                      ) : (
                    ...
                    {comment.attributes.tags &&
                      comment.attributes.tags.length > 0 && (
            ...
            <p className="text-center text-gray-500">
              No comments available for this URL.
            </p>
          )}
        </div>
      </details>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <p className="mt-1 text-lg font-semibold">
                      {
                        votes.filter(
                          (v) => v.attributes?.verdict === "harmless"
                        ).length
                      }
                    </p>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-lg font-semibold">
                      {
                        votes.filter(
                          (v) => v.attributes?.verdict === "malicious"
                        ).length
                      }
                    </p>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-lg font-semibold">
                      {
                        votes.filter(
                          (v) => v.attributes?.verdict === "suspicious"
                        ).length
                      }
                    </p>
